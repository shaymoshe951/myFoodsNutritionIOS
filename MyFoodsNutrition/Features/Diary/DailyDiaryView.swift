            ...
            List {
                ...
                Section {
                    HStack(alignment: .center, spacing: 10) {
                        ...
                        .accessibilityLabel("הוספה עם AI")
                    ...
                    Text("שורה אחת: שם מזון + מספר גרם (למשל «חלב 200»). מצלמה: ניתוח תזונה מתמונה, נפח, או מתיאור טקסט (למשל «קציצות עוף 70 גרם»). «הוסף»/«אוסף» עם התאמה חד־משמעית מוסיפים כמו Enter; «נקה» לבד או אחרי רווח בסוף השורה מרוקן את כל השורה ומאפס הקלטה בקול. ארוחה נקבעת אוטומטית לפי שעת ההוספה, כמו בשרת.")
                }
